...
def speak(text):
    speech_key = "YourAzureSubscriptionKey"
    service_region = "YourServiceRegion"
    speech_config = speechsdk.SpeechConfig(subscription=speech_key, region=service_region)
    
    # Adjust voice parameters
    voice_name = "en-US-GuyNeural"  # Choose a suitable voice
    speech_config.speech_synthesis_voice_name = voice_name
    speech_config.speech_synthesis_pitch = "+0%"  # Adjust pitch
    speech_config.speech_synthesis_rate = "+0%"   # Adjust speed
